      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 sm:pt-8 space-y-6">
        ...
        <div className="space-y-4">
          ...
          {loading ? (
            ...
            <div className="bg-white p-8 sm:p-12 text-center border border-dashed border-slate-300 rounded-2xl shadow-2xs">
              ...
              <h3 className="text-base font-bold text-slate-900 mb-1.5">
                {routes.length === 0
                  ? !user
                    ? t.auth.emptyStateAnonymousTitle
              ...
              <p className="text-xs text-slate-600 max-w-md mx-auto mb-6 font-medium leading-relaxed">
                {routes.length === 0
                  ? !user
                    ? t.auth.emptyStateAnonymousDesc
